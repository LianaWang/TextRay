...
from ..bbox.transforms import bbox2offset


def offset_anchor_target(anchor_list,
                         valid_flag_list,
                         bbox_preds,
                         gt_bboxes_list,
                         gt_cheby_list,
...
def offset_target_single(flat_anchors,
    ...
    bbox_targets = torch.zeros((num_valid_anchors, num_coords), dtype=torch.float).cuda()
    bbox_weights = torch.zeros((num_valid_anchors, num_coords), dtype=torch.float).cuda()
